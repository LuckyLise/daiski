...
if (isset($_GET["q"])) {
    ...
    header("location:users2.php?p=1&order=1");
    ...
    <div class="container">
        ...
        <div class="py-2 row g-3 align-items-center">
            ...
            <div class="col-md-6">
                <div class="hstack gap-2 align-items-center">
                    <? if (isset($_GET["q"])): ?>
                        <a class="btn btn-primary" href="users2.php"><i class="fa-solid fa-arrow-left fa-fw"></i>Go Back</a>
        ...
        <div class="py-2 text-end">
            <div class="btn-group">
                ...
                <a class="btn btn-primary <? if ($order == 1) echo "active" ?>" href="users2.php?p=<?= $p ?>&order=1"><i class="fa-solid fa-arrow-down-1-9 fa-fw"></i></a>
                <a class="btn btn-primary <? if ($order == 2) echo "active" ?>" href="users2.php?p=<?= $p ?>&order=2"><i class="fa-solid fa-arrow-down-9-1" fa-fw></i></a>
                <a class="btn btn-primary <? if ($order == 3) echo "active" ?>" href="users2.php?p=<?= $p ?>&order=3"><i class="fa-solid fa-arrow-down-a-z" fa-fw></i></a>
                <a class="btn btn-primary <? if ($order == 4) echo "active" ?>" href="users2.php?p=<?= $p ?>&order=4"><i class="fa-solid fa-arrow-down-z-a" fa-fw></i></a>
            </div>
        </div>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        ...
                        <? for ($i = 1; $i <= $totalPage; $i++): ?>
                            ...
                            <li class="page-item <?= $active ?>"><a class="page-link" href="users2.php?p=<?= $i ?>&order=<?= $order ?>"><?= $i ?></a></li>
                        <? endfor; ?>
