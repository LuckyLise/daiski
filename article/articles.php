...
<body>
        ...
        <div class="container">
            ...
            <div class="py-2 text-end">
                <div class="btn-group">
                    ...
                    <a class="btn btn-primary <? if ($order == 1) echo "active" ?>" href="articles.php?<?= $q ?>p=<?= $p ?>&order=1">ID升冪<i class="fa-solid fa-arrow-down-1-9 fa-fw"></i></a>
                    <a class="btn btn-primary <? if ($order == 2) echo "active" ?>" href="articles.php?<?= $q ?>p=<?= $p ?>&order=2">ID降冪<i class="fa-solid fa-arrow-down-9-1" fa-fw></i></a>
                    <a class="btn btn-primary <? if ($order == 3) echo "active" ?>" href="articles.php?<?= $q ?>p=<?= $p ?>&order=3">發布升冪<i class="fa-solid fa-arrow-down-a-z" fa-fw></i></a>
                    <a class="btn btn-primary <? if ($order == 4) echo "active" ?>" href="articles.php?<?= $q ?>p=<?= $p ?>&order=4">發布降冪<i class="fa-solid fa-arrow-down-z-a" fa-fw></i></a>
                </div>
            </div>
    ...
    <div class="dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
            <li><a class="btn_category_choose dropdown-item" href="#">2222</a></li>
        </ul>
    </div>
